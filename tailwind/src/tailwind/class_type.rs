...
struct TailWindCss {
    ...
    box_decoration_break: [&'static str; 2],
    box_sizing: [&'static str; 2],
    display: [&'static str; 21],
    float: [&'static str; 3],
    clear: [&'static str; 4],
    isolation: [&'static str; 2],
    object_fit: [&'static str; 5],
    object_position: [&'static str; 9],
    overflow: [&'static str; 15],
    overscroll_behavior: [&'static str; 9],
    position: [&'static str; 5],
    inset: [&'static str; 210],
    top: [&'static str; 42],
    bottom: [&'static str; 42],
    right: [&'static str; 42],
    left: [&'static str; 42],
    visibility: [&'static str; 3],
    z_index: [&'static str; 7],
    flex_basis: [&'static str; 63],
    flex_direction: [&'static str; 4],
    flex: [&'static str; 4],
    flex_grow: [&'static str; 2],
    flex_shrink: [&'static str; 2],
    flex_wrap: [&'static str; 3],
    order: [&'static str; 15],
    gap: [&'static str; 105],
    justify_content: [&'static str; 8],
    justify_items: [&'static str; 4],
    justify_self: [&'static str; 5],
    align_content: [&'static str; 9],
    align_items: [&'static str; 5],
    align_self: [&'static str; 6],
    place_content: [&'static str; 8],
    place_items: [&'static str; 5],
    place_self: [&'static str; 5],
    grid_template_columns: [&'static str; 13],
    grid_auto_columns: [&'static str; 4],
    grid_column: [&'static str; 14],
    grid_column_start: [&'static str; 14],
    grid_column_end: [&'static str; 14],
    grid_template_rows: [&'static str; 7],
    grid_auto_rows: [&'static str; 4],
    grid_row: [&'static str; 8],
    ...
    max_width: [&'static str; 23],
    height: [&'static str; 56],
    min_height: [&'static str; 6],
    max_height: [&'static str; 41],
    font_family: [&'static str; 3],
    font_size: [&'static str; 13],
    font_smoothing: [&'static str; 2],
    font_style: [&'static str; 2],
    font_weight: [&'static str; 9],
    font_variant_numeric: [&'static str; 9],
    letter_spacing: [&'static str; 6],
    line_clamp: [&'static str; 7],
    line_height: [&'static str; 14],
    line_style_image: [&'static str; 1],
    line_style_position: [&'static str; 2],
    line_style_type: [&'static str; 3],
    text_align: [&'static str; 6],
    text_color: [&'static str; 247],
    text_decoration: [&'static str; 4],
    text_decoration_color: [&'static str; 247],
    text_decoration_style: [&'static str; 5],
    text_decoration_thickness: [&'static str; 7],
    text_underline_offset: [&'static str; 6],
    text_transform: [&'static str; 4],
    text_overflow: [&'static str; 3],
    text_indent: [&'static str; 35],
    vertical_align: [&'static str; 8],
    whitespace: [&'static str; 6],
    word_break: [&'static str; 4],
    hyphens: [&'static str; 3],
    content: [&'static str; 1],
    background_attachment: [&'static str; 3],
    background_clip: [&'static str; 4],
    background_color: [&'static str; 247],
    background_origin: [&'static str; 3],
    background_position: [&'static str; 9],
    background_repeat: [&'static str; 6],
    background_size: [&'static str; 3],
    background_image: [&'static str; 9],
    gradient_color_stops: [&'static str; 4],
    border_radius: [&'static str; 135],
    border_width: [&'static str; 45],
    border_color: [&'static str; 2223],
    border_syle: [&'static str; 6],
    border_collapse: [&'static str; 2],
    border_spacing: [&'static str; 105],
    table_layout: [&'static str; 2],
    caption_side: [&'static str; 2],

    divide_width: [&'static str; 12],
    divide_color: [&'static str; 247],
    divide_style: [&'static str; 5],
    outline_width: [&'static str; 5],
    outline_color: [&'static str; 247],
    outline_style: [&'static str; 5],
    outline_offset: [&'static str; 5],
    ring_width: [&'static str; 7],
    ring_color: [&'static str; 247],
    ring_offset_width: [&'static str; 5],
    ring_offset_color: [&'static str; 247],
    box_shadow: [&'static str; 8],
    box_shadow_color: [&'static str; 247],
    opacity: [&'static str; 15],
    mix_blend_mode: [&'static str; 17],
    background_blend_mode: [&'static str; 16],
    blur: [&'static str; 8],
    brightness: [&'static str; 11],
    contrast: [&'static str; 7],
    drop_shadow: [&'static str; 7],
    gray_scale: [&'static str; 2],
    hue_rotate: [&'static str; 6],
    invert: [&'static str; 2],
    saturate: [&'static str; 5],
    sepia: [&'static str; 2],
    backdrop_blur: [&'static str; 8],
    backdrop_brightness: [&'static str; 11],
    backdrop_contrast: [&'static str; 7],
    backdrop_grayscale: [&'static str; 2],
    backdrop_hue_rotate: [&'static str; 6],
    backdrop_invert: [&'static str; 2],
    backdrop_opacity: [&'static str; 15],
    backdrop_saturate: [&'static str; 5],
    backdrop_sepia: [&'static str; 2],
    caret_color: [&'static str; 247],

    scroll_margin: [&'static str; 315],
   
    transform_origin: [&'static str; 9],
    accent_color: [&'static str; 248],
    scale: [&'static str; 30],
    rotate: [&'static str; 9],
    translate: [&'static str; 84],
    skew: [&'static str; 12],
    transition_property: [&'static str; 7],
    transition_timing_function: [&'static str; 4],
    transition_duration: [&'static str; 9],
    transition_delay: [&'static str; 9],
    animation: [&'static str; 5],
    appearance: [&'static str; 1],
    cursor: [&'static str; 36],
    pointer_events: [&'static str; 2],
    resize: [&'static str; 4],
    user_select: [&'static str; 4],
    fill: [&'static str; 248],
    stroke: [&'static str; 248],
    stroke_width: [&'static str; 3],
    scroll_behavior: [&'static str; 2],
    scroll_padding: [&'static str; 315],
    scroll_snap_align: [&'static str; 4],
    scroll_snap_stop: [&'static str; 2],
    scroll_snap_type: [&'static str; 6],
    touch_action: [&'static str; 10],
    will_change: [&'static str; 4],
    scree_readers: [&'static str; 2], // sr_only: [&'static str; 2],
}
...
const TAILWIND: TailWindCss = TailWindCss {
    // MARK: Layout
