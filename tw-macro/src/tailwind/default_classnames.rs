...
pub struct TailWindCssDefaultClassNames {
    ...
    pub break_after: [&'static str; 8],
    pub break_before: [&'static str; 8],
    pub break_inside: [&'static str; 4],
    pub box_decoration_break: [&'static str; 2],
    pub box_sizing: [&'static str; 2],
    pub display: [&'static str; 21],
    pub float: [&'static str; 3],
    pub clear: [&'static str; 4],
    pub isolation: [&'static str; 2],
    pub object_fit: [&'static str; 5],
    pub object_position: [&'static str; 9],
    pub overflow: [&'static str; 15],
    pub overscroll_behavior: [&'static str; 9],
    pub position: [&'static str; 5],
    pub inset: [&'static str; 126],
    pub start: [&'static str; 42],
    pub end: [&'static str; 42],
    pub top: [&'static str; 42],
    pub bottom: [&'static str; 42],
    pub right: [&'static str; 42],
    pub left: [&'static str; 42],
    pub visibility: [&'static str; 3],
    pub z_index: [&'static str; 7],
    pub flex_basis: [&'static str; 63],
    pub flex_direction: [&'static str; 4],
    pub flex: [&'static str; 4],
    pub flex_grow: [&'static str; 2],
    pub flex_shrink: [&'static str; 2],
    pub flex_wrap: [&'static str; 3],
    pub order: [&'static str; 15],
    pub gap: [&'static str; 105],
    pub justify_content: [&'static str; 8],
    pub justify_items: [&'static str; 4],
    pub justify_self: [&'static str; 5],
    pub align_content: [&'static str; 9],
    pub align_items: [&'static str; 5],
    pub align_self: [&'static str; 6],
    pub place_content: [&'static str; 8],
    pub place_items: [&'static str; 5],
    pub place_self: [&'static str; 5],
    pub placeholder_color: [&'static str; 248],
    pub placeholder_opacity: [&'static str; 15],
    pub grid_template_columns: [&'static str; 13],
    pub grid_auto_columns: [&'static str; 4],
    pub grid_column: [&'static str; 14],
    pub grid_column_start: [&'static str; 14],
    pub grid_column_end: [&'static str; 14],
    pub grid_template_rows: [&'static str; 7],
    pub grid_auto_rows: [&'static str; 4],
    pub grid_row: [&'static str; 8],
    pub grid_row_start: [&'static str; 8],
    pub grid_row_end: [&'static str; 8],
    pub grid_auto_flow: [&'static str; 5],
    pub padding: [&'static str; 315],
    pub margin: [&'static str; 315],
    pub space: [&'static str; 72],
    pub width: [&'static str; 67],
    pub min_width: [&'static str; 5],
    pub max_width: [&'static str; 23],
    pub height: [&'static str; 56],
    pub min_height: [&'static str; 6],
    pub max_height: [&'static str; 41],
    pub font_family: [&'static str; 3],
    pub font_size: [&'static str; 13],
    pub font_smoothing: [&'static str; 2],
    pub font_style: [&'static str; 2],
    pub font_weight: [&'static str; 9],
    pub font_variant_numeric: [&'static str; 9],
    ...
    pub text_decoration_color: [&'static str; 247],
    pub text_decoration_style: [&'static str; 5],
    pub text_decoration_thickness: [&'static str; 7],
    pub text_underline_offset: [&'static str; 6],
    pub text_transform: [&'static str; 4],
    pub text_overflow: [&'static str; 3],
    pub text_indent: [&'static str; 35],
    pub vertical_align: [&'static str; 8],
    pub whitespace: [&'static str; 6],
    pub word_break: [&'static str; 4],
    pub hyphens: [&'static str; 3],
    pub content: [&'static str; 1],
    pub background_attachment: [&'static str; 3],
    pub background_clip: [&'static str; 4],
    pub background_color: [&'static str; 247],
    pub background_origin: [&'static str; 3],
    pub background_position: [&'static str; 9],
    pub background_repeat: [&'static str; 6],
    pub background_size: [&'static str; 3],
    pub background_image: [&'static str; 9],
    pub gradient_color_stops: [&'static str; 4],
    ...
    pub caption_side: [&'static str; 2],
    pub divide_width: [&'static str; 12],
    pub divide_color: [&'static str; 247],
    pub divide_style: [&'static str; 5],
    pub outline_width: [&'static str; 5],
    pub outline_color: [&'static str; 247],
    pub outline_style: [&'static str; 5],
    pub outline_offset: [&'static str; 5],
    pub ring_width: [&'static str; 7],
    pub ring_color: [&'static str; 247],
    pub ring_offset_width: [&'static str; 5],
    pub ring_offset_color: [&'static str; 247],
    pub box_shadow: [&'static str; 8],
    pub box_shadow_color: [&'static str; 247],
    pub opacity: [&'static str; 15],
    pub border_opacity: [&'static str; 135],
    pub mix_blend_mode: [&'static str; 17],
    pub background_blend_mode: [&'static str; 16],
    pub blur: [&'static str; 8],
    ...
    pub sepia: [&'static str; 2],
    pub backdrop_blur: [&'static str; 8],
    pub backdrop_brightness: [&'static str; 11],
    pub backdrop_contrast: [&'static str; 7],
    pub backdrop_grayscale: [&'static str; 2],
    pub backdrop_hue_rotate: [&'static str; 6],
    pub backdrop_invert: [&'static str; 2],
    pub backdrop_opacity: [&'static str; 15],
    pub backdrop_saturate: [&'static str; 5],
    pub backdrop_sepia: [&'static str; 2],
    pub caret_color: [&'static str; 247],
    ...
    pub skew: [&'static str; 12],
    pub transition_property: [&'static str; 7],
    pub transition_timing_function: [&'static str; 4],
    pub transition_duration: [&'static str; 9],
    pub transition_delay: [&'static str; 9],
    pub animation: [&'static str; 5],
    pub appearance: [&'static str; 1],
    pub cursor: [&'static str; 36],
    pub pointer_events: [&'static str; 2],
    pub resize: [&'static str; 4],
    pub user_select: [&'static str; 4],
    pub fill: [&'static str; 248],
    pub stroke: [&'static str; 248],
    pub stroke_width: [&'static str; 3],
    pub scroll_behavior: [&'static str; 2],
    pub scroll_padding: [&'static str; 315],
    pub scroll_snap_align: [&'static str; 4],
    pub scroll_snap_stop: [&'static str; 2],
...
pub const TAILWIND_CSS: TailWindCssDefaultClassNames = TailWindCssDefaultClassNames {
    ...
    /* Aspect Ratio */
    aspect_ratio: ["aspect-auto", "aspect-video", "aspect-square"],

    /* Container */
    container: ["container", "mx-auto", "max-width", "min-width"],
    ...
    box_decoration_break: ["box-decoration-clone", "box-decoration-slice"],

    /* Box Sizing */
    box_sizing: ["box-border", "box-content"],
    ...
    start: [
        ...
        "end-px", "end-0", "end-1", "end-2", "end-3", "end-4", "end-5", "end-6", "end-7", "end-8",
        "end-9", "end-10", "end-11", "end-12", "end-14", "end-16", "end-20", "end-24", "end-28",
        "end-32", "end-36", "end-44", "end-48", "end-52", "end-56", "end-60", "end-64", "end-72",
        "end-80", "end-96", "end-auto", "end-1/2", "end-1/3", "end-2/3", "end-1/4", "end-2/4",
        "end-3/4", "end-full", "end-0.5", "end-1.5", "end-2.5", "end-3.5",
    ],
    inset: [
        "inset-px",
        "inset-x-px",
    ...
    top: [
        ...
        "top-px", "top-0", "top-0.5", "top-1", "top-1.5", "top-2", "top-2.5", "top-3", "top-3.5",
        "top-4", "top-5", "top-6", "top-7", "top-8", "top-9", "top-10", "top-11", "top-12",
        "top-14", "top-16", "top-20", "top-24", "top-28", "top-32", "top-36", "top-44", "top-48",
        "top-52", "top-56", "top-60", "top-64", "top-72", "top-80", "top-96",
    ],
    bottom: [
        "bottom-auto",
        "bottom-1/2",
    ...
    /* Flex Grow */
    flex_grow: ["grow", "grow-0"],

    /* Flex Shrink */
    flex_shrink: ["shrink", "shrink-0"],
    ...
    padding: [
        ...
        "p-32", "p-36", "p-40", "p-44", "p-48", "p-52", "p-56", "p-60", "p-64", "p-72", "p-80",
        "p-96", "px-0", "px-px", "px-0.5", "px-1", "px-1.5", "px-2", "px-2.5", "px-3", "px-3.5",
        "px-4", "px-5", "px-6", "px-7", "px-8", "px-9", "px-10", "px-11", "px-12", "px-14",
        "px-16", "px-20", "px-24", "px-28", "px-32", "px-36", "px-40", "px-44", "px-48", "px-52",
        "px-56", "px-60", "px-64", "px-72", "px-80", "px-96", "py-0", "py-px", "py-0.5", "py-1",
        "py-1.5", "py-2", "py-2.5", "py-3", "py-3.5", "py-4", "py-5", "py-6", "py-7", "py-8",
        "py-9", "py-10", "py-11", "py-12", "py-14", "py-16", "py-20", "py-24", "py-28", "py-32",
        "py-36", "py-40", "py-44", "py-48", "py-52", "py-56", "py-60", "py-64", "py-72", "py-80",
        "py-96", "ps-0", "ps-px", "ps-0.5", "ps-1", "ps-1.5", "ps-2", "ps-2.5", "ps-3", "ps-3.5",
        "ps-4", "ps-5", "ps-6", "ps-7", "ps-8", "ps-9", "ps-10", "ps-11", "ps-12", "ps-14",
        "ps-16", "ps-20", "ps-24", "ps-28", "ps-32", "ps-36", "ps-40", "ps-44", "ps-48", "ps-52",
        "ps-56", "ps-60", "ps-64", "ps-72", "ps-80", "ps-96", "pe-0", "pe-px", "pe-0.5", "pe-1",
        "pe-1.5", "pe-2", "pe-2.5", "pe-3", "pe-3.5", "pe-4", "pe-5", "pe-6", "pe-7", "pe-8",
        "pe-9", "pe-10", "pe-11", "pe-12", "pe-14", "pe-16", "pe-20", "pe-24", "pe-28", "pe-32",
        "pe-36", "pe-40", "pe-44", "pe-48", "pe-52", "pe-56", "pe-60", "pe-64", "pe-72", "pe-80",
        "pe-96", "pt-0", "pt-px", "pt-0.5", "pt-1", "pt-1.5", "pt-2", "pt-2.5", "pt-3", "pt-3.5",
        "pt-4", "pt-5", "pt-6", "pt-7", "pt-8", "pt-9", "pt-10", "pt-11", "pt-12", "pt-14",
        "pt-16", "pt-20", "pt-24", "pt-28", "pt-32", "pt-36", "pt-40", "pt-44", "pt-48", "pt-52",
        "pt-56", "pt-60", "pt-64", "pt-72", "pt-80", "pt-96", "pr-0", "pr-px", "pr-0.5", "pr-1",
        "pr-1.5", "pr-2", "pr-2.5", "pr-3", "pr-3.5", "pr-4", "pr-5", "pr-6", "pr-7", "pr-8",
        "pr-9", "pr-10", "pr-11", "pr-12", "pr-14", "pr-16", "pr-20", "pr-24", "pr-28", "pr-32",
        "pr-36", "pr-40", "pr-44", "pr-48", "pr-52", "pr-56", "pr-60", "pr-64", "pr-72", "pr-80",
        "pr-96", "pb-0", "pb-px", "pb-0.5", "pb-1", "pb-1.5", "pb-2", "pb-2.5", "pb-3", "pb-3.5",
        "pb-4", "pb-5", "pb-6", "pb-7", "pb-8", "pb-9", "pb-10", "pb-11", "pb-12", "pb-14",
        "pb-16", "pb-20", "pb-24", "pb-28", "pb-32", "pb-36", "pb-40", "pb-44", "pb-48", "pb-52",
        "pb-56", "pb-60", "pb-64", "pb-72", "pb-80", "pb-96", "pl-0", "pl-px", "pl-0.5", "pl-1",
        "pl-1.5", "pl-2", "pl-2.5", "pl-3", "pl-3.5", "pl-4", "pl-5", "pl-6", "pl-7", "pl-8",
        "pl-9", "pl-10", "pl-11", "pl-12", "pl-14", "pl-16", "pl-20", "pl-24", "pl-28", "pl-32",
        "pl-36", "pl-40", "pl-44", "pl-48", "pl-52", "pl-56", "pl-60", "pl-64", "pl-72", "pl-80",
        "pl-96",
    ],
    /* Margin */
    margin: [
        ...
        "m-96", "mx-0", "mx-px", "mx-0.5", "mx-1", "mx-1.5", "mx-2", "mx-2.5", "mx-3", "mx-3.5",
        "mx-4", "mx-5", "mx-6", "mx-7", "mx-8", "mx-9", "mx-10", "mx-11", "mx-12", "mx-14",
        "mx-16", "mx-20", "mx-24", "mx-28", "mx-32", "mx-36", "mx-40", "mx-44", "mx-48", "mx-52",
        "mx-56", "mx-60", "mx-64", "mx-72", "mx-80", "mx-96", "my-0", "my-px", "my-0.5", "my-1",
        "my-1.5", "my-2", "my-2.5", "my-3", "my-3.5", "my-4", "my-5", "my-6", "my-7", "my-8",
        "my-9", "my-10", "my-11", "my-12", "my-14", "my-16", "my-20", "my-24", "my-28", "my-32",
        "my-36", "my-40", "my-44", "my-48", "my-52", "my-56", "my-60", "my-64", "my-72", "my-80",
        "my-96", "ms-0", "ms-px", "ms-0.5", "ms-1", "ms-1.5", "ms-2", "ms-2.5", "ms-3", "ms-3.5",
        "ms-4", "ms-5", "ms-6", "ms-7", "ms-8", "ms-9", "ms-10", "ms-11", "ms-12", "ms-14",
        "ms-16", "ms-20", "ms-24", "ms-28", "ms-32", "ms-36", "ms-40", "ms-44", "ms-48", "ms-52",
        "ms-56", "ms-60", "ms-64", "ms-72", "ms-80", "ms-96", "me-0", "me-px", "me-0.5", "me-1",
        "me-1.5", "me-2", "me-2.5", "me-3", "me-3.5", "me-4", "me-5", "me-6", "me-7", "me-8",
        "me-9", "me-10", "me-11", "me-12", "me-14", "me-16", "me-20", "me-24", "me-28", "me-32",
        "me-36", "me-40", "me-44", "me-48", "me-52", "me-56", "me-60", "me-64", "me-72", "me-80",
        "me-96", "mt-0", "mt-px", "mt-0.5", "mt-1", "mt-1.5", "mt-2", "mt-2.5", "mt-3", "mt-3.5",
        "mt-4", "mt-5", "mt-6", "mt-7", "mt-8", "mt-9", "mt-10", "mt-11", "mt-12", "mt-14",
        "mt-16", "mt-20", "mt-24", "mt-28", "mt-32", "mt-36", "mt-40", "mt-44", "mt-48", "mt-52",
        "mt-56", "mt-60", "mt-64", "mt-72", "mt-80", "mt-96", "mr-0", "mr-px", "mr-0.5", "mr-1",
        "mr-1.5", "mr-2", "mr-2.5", "mr-3", "mr-3.5", "mr-4", "mr-5", "mr-6", "mr-7", "mr-8",
        "mr-9", "mr-10", "mr-11", "mr-12", "mr-14", "mr-16", "mr-20", "mr-24", "mr-28", "mr-32",
        "mr-36", "mr-40", "mr-44", "mr-48", "mr-52", "mr-56", "mr-60", "mr-64", "mr-72", "mr-80",
        "mr-96", "mb-0", "mb-px", "mb-0.5", "mb-1", "mb-1.5", "mb-2", "mb-2.5", "mb-3", "mb-3.5",
        "mb-4", "mb-5", "mb-6", "mb-7", "mb-8", "mb-9", "mb-10", "mb-11", "mb-12", "mb-14",
        "mb-16", "mb-20", "mb-24", "mb-28", "mb-32", "mb-36", "mb-40", "mb-44", "mb-48", "mb-52",
        "mb-56", "mb-60", "mb-64", "mb-72", "mb-80", "mb-96", "ml-0", "ml-px", "ml-0.5", "ml-1",
        "ml-1.5", "ml-2", "ml-2.5", "ml-3", "ml-3.5", "ml-4", "ml-5", "ml-6", "ml-7", "ml-8",
        "ml-9", "ml-10", "ml-11", "ml-12", "ml-14", "ml-16", "ml-20", "ml-24", "ml-28", "ml-32",
        "ml-36", "ml-40", "ml-44", "ml-48", "ml-52", "ml-56", "ml-60", "ml-64", "ml-72", "ml-80",
        "ml-96",
    ],
    ...
    width: [
        ...
        "w-6", "w-7", "w-8", "w-9", "w-10", "w-11", "w-12", "w-14", "w-16", "w-20", "w-24", "w-28",
        "w-32", "w-36", "w-40", "w-44", "w-48", "w-52", "w-56", "w-60", "w-64", "w-72", "w-80",
        "w-96", "w-1/2", "w-1/3", "w-2/3", "w-1/4", "w-2/4", "w-3/4", "w-1/5", "w-2/5", "w-3/5",
        "w-4/5", "w-1/6", "w-2/6", "w-3/6", "w-4/6", "w-5/6", "w-1/12", "w-2/12", "w-3/12",
        "w-4/12", "w-5/12", "w-6/12", "w-7/12", "w-8/12", "w-9/12", "w-10/12", "w-11/12", "w-auto",
    ...
    height: [
        ...
        "h-6", "h-7", "h-8", "h-9", "h-10", "h-11", "h-12", "h-14", "h-16", "h-20", "h-24", "h-28",
        "h-32", "h-36", "h-40", "h-44", "h-48", "h-52", "h-56", "h-60", "h-64", "h-72", "h-80",
        "h-96", "h-1/2", "h-1/3", "h-2/3", "h-1/4", "h-2/4", "h-3/4", "h-1/5", "h-2/5", "h-3/5",
        "h-4/5", "h-1/6", "h-2/6", "h-3/6", "h-4/6", "h-5/6", "h-auto", "h-full", "h-screen",
        "h-min", "h-max", "h-fit",
    ],
    ...
    /* Background Origin */
    background_origin: ["bg-origin-border", "bg-origin-padding", "bg-origin-content"],
    ...
    /* Backdrop Grayscale */
    backdrop_grayscale: ["backdrop-grayscale-0", "backdrop-grayscale"],
    ...
    /* Backdrop Invert */
    backdrop_invert: ["backdrop-invert-0", "backdrop-invert"],
    ...
    /* Backdrop Sepia */
    backdrop_sepia: ["backdrop-sepia-0", "backdrop-sepia"],
    ...
    /* Caption Side */
    caption_side: ["caption-top", "caption-bottom"],
    ...
    transition_timing_function: ["ease-linear", "ease-in", "ease-out", "ease-in-out"],
    ...
    /* Scroll Behavior */
    scroll_behavior: ["scroll-auto", "scroll-smooth"],
    ...
    /* Scroll Snap Align */
    scroll_snap_align: ["snap-start", "snap-end", "snap-center", "snap-align-none"],

    /* Scroll Snap Stop */
    scroll_snap_stop: ["snap-normal", "snap-always"],
    ...
    /* Stroke Width */
    stroke_width: ["stroke-0", "stroke-1", "stroke-2"],
